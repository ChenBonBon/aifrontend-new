...
export default function App() {
  return (
    <section className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
      <p className="text-sm font-medium uppercase tracking-wide text-sky-700">Remote application</p>
      <h1 className="mt-3 text-3xl font-semibold text-slate-950">Workspace</h1>
      <p className="mt-3 max-w-2xl text-slate-600">
        This screen is rendered by <code>apps/workspace</code> and exposed to the shell through{" "}
